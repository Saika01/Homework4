      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $list[0]['date'] ?><span
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $list[$i]['name'] ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $list[$i]['date'] ?>
            <p><?php echo $list[$i]['description']?></p>
            <hr>
          </div>
          <?php } ?>
        </div>
